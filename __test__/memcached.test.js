...
describe('Testing add',()=>{
    ...
    const request = new Request('add','testing_add',0,200,7,0);
    ...
    test('Testing add duplicated',()=>{
        ...
        const request_duplicated = new Request('add','testing_add',0,200,18,0);
...
describe('Testing Set',()=>{
    const request = new Request('set','testing_set',0,200,7,0);
    request.setValue('testing');
    test('Setting a Key',()=>{
...
describe('Testing Replace',()=>{
    const request = new Request('set','testing_replace',0,200,7,0);
    request.setValue('testing');
    memcached.setKey(request);
    

    test('Testing replace key "testing_replace"',()=>{
        const request_replace = new Request('replace','testing_replace',0,200,15,0);
    ...
    test('Testing replace a key which the store does not have data for this key',()=>{
        const request_replace = new Request('replace','testing_replace_error',0,200,7,0);
...
describe('Testing Prepend',()=>{
    const request = new Request('set','testing_prepend',0,200,7,0);
    ...
    test('Testing prepend a key which the store does not have data for this key',()=>{
        const request_prepend = new Request('prepend','testing_prepend_error',0,200,7,0);
...
describe('Testing Append',()=>{
    const client='testing:00'
    const request = new Request('set','testing_append',0,200,7,0);
    request.setValue('testing');
    memcached.setKey(request);
    ...
    test('Testing appending a key which the store does not have data for this key',()=>{
        const request_append = new Request('append','testing_append_error',0,200,7,0);
...
describe('Testing Cas',()=>{
    const request = new Request('set','testing_cas',0,200,7,0);
    request.setValue('testing');
    memcached.setKey(request);
    
    test('Testing cas key "testing_cas" ',()=>{
        memcached.getKeyValue('testing_cas').then(request_gets=>{
            const request_cas = new Request('cas','testing_cas',0,200,7,0,request_gets.cas_unique);
    ...
    test('Testing cas a key which the store does not have data for this key',()=>{
        const request_cas = new Request('cas','testing_cas_error',0,200,7,0);
    ...
    test('Testing cas  a key "testing_cas" which has been updated',()=>{
        const request_error = new Request('set','testing_cas_error',0,200,7,0);
        request_error.setValue('testing');
        memcached.setKey(request_error);
        const request_gets = memcached.getKeyValue('testing_cas_error')
        const request_cas = new Request('replace','testing_cas_error',0,200,7,0);
        request_cas.setValue('testing');
        
        memcached.replaceKey(request_cas);

        const request_cas_error = new Request('cas','testing_cas_error',0,200,7,0,request_gets.cas_unique);
...
describe('Testing Get',()=>{
    const request_first_get = new Request('set','testing_get1',0,200,7,0);
    request_first_get.setValue('testing');
    memcached.setKey(request_first_get);
    const request_second_get = new Request('set','testing_get2',0,200,7,0);
    ...
    test('Get the value of the key "testing_get_not_found" which is not stored in memcached',()=>{
        const key ='testing_get_not_found';
